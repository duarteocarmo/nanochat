...
# all the setup stuff
export NANOCHAT_BASE_DIR="$HOME/.cache/nanochat-pt"
...
# Sometimes the model likes it if you first say Olá before you ask it questions.
# python -m scripts.chat_cli -p "Qual é a capital de Portugal?"
