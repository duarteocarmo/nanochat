...
- Basic Portugal QA: [`duarteocarmo/portugal-basic-qa-ptcore`](https://huggingface.co/datasets/duarteocarmo/portugal-basic-qa-ptcore); 50 val rows; random baseline 0.333; 3-way multiple choice with European Portuguese prompts, `a`-`c` labels, and answer-text scoring.
